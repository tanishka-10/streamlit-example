...
webpage <- read_html("https://en.wikipedia.org/w/index.php?title=S%26P/TSX_Composite_Index")
tbls <- html_nodes(webpage, "table")
print(tbls)
ticker_names_table <-tbls[2]
print(ticker_names_table)
html_table::html_table("https://en.wikipedia.org/w/index.php?title=S%26P/TSX_Composite_Index", 2)
print(ticker_names_table)
...
period_returns_TSX <-  symbols %>%
tq_get(get  = "stock.prices",from = "2021-07-01",to   = "2021-11-10") %>%
